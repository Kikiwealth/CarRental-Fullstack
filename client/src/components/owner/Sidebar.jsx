...
const Sidebar = () => {
  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 mxa-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        ...
        <div className='w-full'>
            {Array.isArray(ownerMenuLinks) && ownerMenuLinks.filter(link => link && link.path).map((link, index) => (
