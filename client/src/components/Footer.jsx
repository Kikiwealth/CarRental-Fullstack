    ...
    >
      ...
      >
        <div>
          ...
          >
            Premium car rental service withh a wide selection of luxury and
        ...
        <div>
          ...
          <ul className="flex flex-col gap-1.5">
            ...
            <li>
              <a href="#">+234 902 017 7878</a>
            </li>
            <li>
              <a href="mailto:rihadmahrezjr88@gmail.com">rihadmahrezjr88gmail.com</a>
            </li>
          </ul>
        </div>
