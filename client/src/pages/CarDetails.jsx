...
const CarDetails = () => {
  ...
  return car ? (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
            ...
            >
                ...
                <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                  {[
                    ...
                    key={text} className='flexmflex-col items-center bg-light p-4 rounded-lg'>
      ...
      onSubmit={handleSubmit} className='showdow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
